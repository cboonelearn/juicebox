...
async function getPostsByUser(userId) {
	try {
		...
		console.error("ERROR in getPostByUser")
		throw error;
	}
}
...
async function getAllTags() {
	...
	return rows;
		...
		console.error("ERROR in getAllTags")
		throw error;
	}
}
...
async function createTags(tagList) {
	...
	try {
		...
		// return nothing, we'll query after
		const { rowsInsert } = await client.query(`
...
async function createPostTag(postId, tagId) {
	try {
	  ...
	  `, [postId, tagId]);
		...
		console.error("ERROR in createPostTag");
	  throw error;
	}
  }
...
async function getPostsByTagName(tagName) {
	try {
		...
		console.error("ERROR in getPostsByTagName");
		throw error;
	}
}
